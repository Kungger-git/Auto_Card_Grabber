...
while True:
	...
	generateCard = driver.find_element_by_xpath('/html/body/div[6]/div[2]/div/div[2]/div[1]/div/div[2]/div[2]/div/div[1]/div/div[1]/button')
	generateCard.click()
	generateCard.click()

	time.sleep(35)
	getCardNumber = driver.find_element_by_xpath('//*[@id="card_number_id"]').text
	getName = driver.find_element_by_xpath('//*[@id="card_name_id"]').text
	getAddress = driver.find_element_by_xpath('//*[@id="card_address_id"]').text
	getCountry = driver.find_element_by_xpath('//*[@id="card_country_id"]').text
	...
	with open(filename, 'a') as f:
		f.write(getCardNumber + ', ' + getName + ', ' + getAddress.replace(",","") + ', ' + getCountry.replace(",","") + ', ' + getCVV + ', ' + getEXP + '\n\n')
